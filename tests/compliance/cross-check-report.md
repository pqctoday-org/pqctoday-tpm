...
5. ~~**wolfTPM upstream `mlkem.h` rename PR**~~ — **RESOLVED 2026-05-12.** Filed as [wolfSSL/wolfTPM#499](https://github.com/wolfSSL/wolfTPM/issues/499), fixed upstream by [PR #501](https://github.com/wolfSSL/wolfTPM/pull/501) (merged 2026-05-11, commit `0ae18dc…`). Our `WOLFTPM_REF` is now pinned to that merge commit; the `Dockerfile.xcheck` + `.github/workflows/xcheck.yml` symlink workaround has been removed. **Re-verified: 29 PASS / 0 FAIL** without the symlink, same baseline. See [`docs/upstream-issues/wolfTPM-001-mlkem-header-rename.md`](../../docs/upstream-issues/wolfTPM-001-mlkem-header-rename.md) for the historical record.
